...
<section class="flex">
  ...
  <p class="auto-width pc-narrow">
    ...
    and apps - all within a single, unified ecosystem. Not just our products: independent teams, creators, brands, franchises, and filmmakers build on DGRS's modular building blocks.
  </p>
