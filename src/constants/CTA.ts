const callToAction: CTA[] = [
  {
    name: 'play',
    color: (opacity: number = 1) => `rgba(60, 180, 185, ${opacity})`,
  ...
  {
    name: 'create',
    color: (opacity: number = 1) => `rgba(56, 117, 250, ${opacity})`,
  ...
  {
    name: 'build',
    color: (opacity: number = 1) => `rgba(255, 140, 0, ${opacity})`,
  ...
  {
    name: 'invest',
    color: (opacity: number = 1) => `rgba(160, 120, 255, ${opacity})`,
  ...
  {
    name: 'give',
    color: (opacity: number = 1) => `rgba(230, 175, 175, ${opacity})`,
